...
const CookingClass: React.FC<CookingClassProps> = ({ className = "" }) => (
  <div id="cookingClass" className={classNames(style.CookingClass, className)}>
    ...
    <p className={style.CookingClass__descriptionEn}>
      ...
      depends on your ideas. It has good access from Asakusa Station, making it
      easy for students to commute.
    </p>
  </div>
);
