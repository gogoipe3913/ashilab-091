...
const FoodEvents: React.FC<FoodEventsProps> = ({ className = "" }) => (
  <div id="foodEvents" className={classNames(style.FoodEvents, className)}>
    ...
    <p className={style.FoodEvents__descriptionEn}>
      Wine tastings, sake tastings, new recipe presentations, events with lunch
      where chefs show off their skills, etc. It can be used for various food
      events. By changing the layout, you can have both standing and seated
      dining styles. It is especially suitable for corporate PR events promoting
      food. Use the kitchen studio freely, have variety and value You can set up
      a food event.
    </p>
  </div>
);
